        ...
        <div className="flex h-screen bg-[#F6F8FC] overflow-hidden">
            ...
            <main className="flex-1 ml-64 min-h-screen flex">
                ...
                <div className="w-[340px] flex flex-col h-full border-r border-slate-200 bg-[#F6F8FC]">
                    ...
                    {/* Header Zone */}
                    {/* 1. Header Band - Matches Right Side Height (h-24) */}
                            ...
                            return (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        isSelected
                                            ? "bg-[#E3F2FD] z-10"
                                            : "bg-white hover:bg-slate-50 z-0"
                                    )}
                                >
                                    {/* Selection Bar */}
                                    {isSelected && (
                                        <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#1E293B]" />
                                    )}

                                    {/* Validated Decoration */}
                                    {isValidated && (
                                        /* Green Vertical Bar (Right) */
                                        <div className="absolute right-0 top-0 bottom-0 w-1.5 bg-[#4CAF50]" />
                                    )}
                                    ...
                                    <div className={cn("relative z-10 flex flex-col h-full justify-center gap-1 transition-transform duration-200", isSelected ? "translate-x-[6px]" : "")}>
                                        ...
                                        <div className="flex justify-between items-end w-full">
                                            <span className={cn(
                                                "text-xs font-bold font-outfit tracking-wide mb-0.5",
                    ...
                    <div className="h-24 border-b border-white/10 bg-[#1E293B] shrink-0 shadow-md z-20 px-4 flex items-center justify-between gap-4">
                        ...
                        <div className="flex w-[40%] h-16 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden shadow-xl">
                            ...
                            >
                                ...
                                <span className={cn(
                                    ...
                                    activeAction === 'new' ? "text-orange-400" : "text-white"
                                )}>
                                    Nouvelle
                                </span>
                            </button>
                            ...
                            >
                                ...
                                <span className={cn(
                                    "text-xs font-black uppercase tracking-widest transition-colors duration-300",
                                    activeAction === 'empty' ? "text-orange-400" : "text-white"
                                )}>
                                    Vide
                                </span>
                            </button>
                            ...
                            >
                                ...
                                <span className={cn(
                                    "text-xs font-black uppercase tracking-widest transition-colors duration-300",
                                    activeAction === 'full' ? "text-orange-400" : "text-white"
                                )}>
                                    Pleine
                                </span>
                            </button>
                        ...
                        <div className="flex w-[12%] h-16 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden shadow-xl">
                            <button
                                ...
                                className="flex-1 flex items-center justify-center gap-2 text-white hover:bg-white/10 transition-colors text-xs font-black uppercase tracking-widest active:bg-white/20"
                            >
