                ...
                <table className="w-full text-sm border-collapse">
                    <thead className="bg-slate-100/50 text-xs text-slate-500 uppercase font-semibold">
                        <tr className="border-b border-slate-200">
                            <th className="px-2 py-1.5 text-center w-10">P.</th>
                            <th className="px-2 py-1.5 text-left w-28">Date</th>
                            <th className="px-2 py-1.5 text-left w-32">Tiers</th>
                            <th className="px-2 py-1.5 text-left">Libellé</th>
                            <th className="px-2 py-1.5 text-left w-32">N° Pièce</th>
                            <th className="px-2 py-1.5 text-right text-red-600 w-24">Débit</th>
                            <th className="px-2 py-1.5 text-right text-green-600 w-24">Crédit</th>
                            <th className="px-2 py-1.5 text-right w-28 pl-4">Actions</th>
                        </tr>
                    </thead>
                        ...
                        {transactions.map(tx => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Date */}
                                    <td className="px-2 py-1.5 font-mono text-[13px] text-slate-600">
                                        {formatDate(tx.date)}
                                    </td>

                                    {/* Tiers */}
                                    <td className="px-2 py-1.5 text-slate-700 font-medium whitespace-nowrap overflow-hidden text-ellipsis max-w-[120px] text-[13px]">
                                        {tx.tier || "-"}
                                    </td>

                                    {/* Libellé */}
                                    <td className="px-2 py-1.5 text-slate-800 whitespace-nowrap overflow-hidden text-ellipsis max-w-[200px] text-[13px]">
                                        {tx.label}
                                    </td>
                                    ...
                                    {/* Débit */}
                                    <td className="px-2 py-1.5 text-right font-bold text-red-600/90 font-mono text-[13px]">
                                        {!isCredit ? tx.amount.toFixed(2) : "-"}
                                    </td>

                                    {/* Crédit */}
                                    <td className="px-2 py-1.5 text-right font-bold text-green-600/90 font-mono text-[13px]">
                                        {isCredit ? tx.amount.toFixed(2) : "-"}
                                    </td>
